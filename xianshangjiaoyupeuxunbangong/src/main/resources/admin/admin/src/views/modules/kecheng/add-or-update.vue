    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="课程标题" prop="kechengName">
                       <el-input v-model="ruleForm.kechengName"
                                 placeholder="课程标题" clearable  :readonly="ro.kechengName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="课程标题" prop="kechengName">
                           <el-input v-model="ruleForm.kechengName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengPhoto" label="课程照片" prop="kechengPhoto">
                        <file-upload
                            tip="点击上传课程照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.kechengPhoto?$base.url+ruleForm.kechengPhoto:''"
                            @change="kechengPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengPhoto" label="课程照片" prop="kechengPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.kechengPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="课程时长" prop="kechengShichang">
                       <el-input v-model="ruleForm.kechengShichang"
                                 placeholder="课程时长" clearable  :readonly="ro.kechengShichang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="课程时长" prop="kechengShichang">
                           <el-input v-model="ruleForm.kechengShichang"
                                     placeholder="课程时长" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="开始时间" prop="kechengTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.kechengTime"
                                type="datetime"
                                placeholder="开始时间"
                                :disabled="ro.kechengTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kechengTime" label="开始时间" prop="kechengTime">
                            <span v-html="ruleForm.kechengTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kechengPhoto: [
                              { required: true, message: '课程照片不能为空', trigger: 'blur' },
                          ],
                   kechengTypes: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.kechengContent = _this.ruleForm.kechengContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.kechengContent = this.ruleForm.kechengContent.replaceAll(this.$base.url,"");
                        this.$http({
