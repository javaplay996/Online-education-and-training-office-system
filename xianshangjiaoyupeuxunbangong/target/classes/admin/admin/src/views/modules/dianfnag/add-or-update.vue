    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="dianfnagName">
                       <el-input v-model="ruleForm.dianfnagName"
                                 placeholder="标题" clearable  :readonly="ro.dianfnagName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="标题" prop="dianfnagName">
                           <el-input v-model="ruleForm.dianfnagName"
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="本周电访次数" prop="dianfnagCishu">
                       <el-input v-model="ruleForm.dianfnagCishu"
                                 placeholder="本周电访次数" clearable  :readonly="ro.dianfnagCishu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="本周电访次数" prop="dianfnagCishu">
                           <el-input v-model="ruleForm.dianfnagCishu"
                                     placeholder="本周电访次数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="本周电访时间" prop="dianfnagShijian">
                       <el-input v-model="ruleForm.dianfnagShijian"
                                 placeholder="本周电访时间" clearable  :readonly="ro.dianfnagShijian"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="本周电访时间" prop="dianfnagShijian">
                           <el-input v-model="ruleForm.dianfnagShijian"
                                     placeholder="本周电访时间" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="dianfnagText">
                        <el-input type="textarea"  :readonly="ro.dianfnagText" v-model="ruleForm.dianfnagText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.dianfnagText" label="备注" prop="dianfnagText">
                            <span v-html="ruleForm.dianfnagText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   dianfnagCishu: [
                              { required: true, message: '本周电访次数不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   dianfnagShijian: [
                              { required: true, message: '本周电访时间不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`dianfnag/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.dianfnagCrossAddOrUpdateFlag = false;
                                        this.parent.search();
