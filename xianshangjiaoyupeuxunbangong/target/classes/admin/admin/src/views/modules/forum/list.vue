                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">回帖详情</el-button>
                            <el-button v-if="true &&( false|| (sessionTable == 'jiaoshi' && scope.row.jiaoshiId ==userId)
|| (sessionTable == 'yonghu' && scope.row.yonghuId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xianshangjiaoyupeuxunbangong/upload/forumMuBan.xls"
                        >批量导入交流平台数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.banjiTypes = el.banjiTypes;
                            forum.yonghuDelete = el.yonghuDelete;
                            forum.createTime = el.createTime;
                            forum.jiaoshiId = el.jiaoshiId;//---
                            forum.jiaoshiName = el.jiaoshiName;
                            forum.jiaoshiPhoto = el.jiaoshiPhoto;
                            forum.jiaoshiIdNumber = el.jiaoshiIdNumber;
                            forum.jiaoshiPhone = el.jiaoshiPhone;
                            forum.jiaoshiEmail = el.jiaoshiEmail;
                            forum.jiaoshiDelete = el.jiaoshiDelete;
                            forum.createTime = el.createTime;
